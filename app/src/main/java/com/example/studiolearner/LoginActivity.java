...
public class LoginActivity extends AppCompatActivity {
    ...
    public static BlogPreferences preferences;
    ...
    private void onLoginClicked() {
        ...
        if(username.isEmpty()) textUsernameLayout.setError("Username cannot be empty");
        else if(password.isEmpty()) textPasswordInput.setError("Password cannot be empty");
    ...
    private void showErrorDialog() {
        new AlertDialog.Builder(this).setTitle("Log In Failed")
